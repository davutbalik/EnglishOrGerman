...
//calculated_frequencies[] => Hesapladigimiz frekanslar , frequency_eng[],frequency_germ[] => verilen degerler , dist[] => distances [2]
    ...
    dist[0]=engdeger; //Bigram ve trigramlarimizin Ingl�zce diline olan oklid uzakliginin 0. indise atanmasi.
...
//dist[] => distance[2],  languages[][8] => verilen dizi
    ...
    if(dist[0]>dist[1])
        ...
        // Almanca diline olan uzakligin Ing�l�zce diline olan uzakliktan fazla olmasi durumunda Ing�l�zce dilinin secilmesi islemi.
